...
<x-app-layout>
        <div class="top-bar">
            ...
            <h2 class="navigation-title">Edit Services</h2>
        </div>
                ...
                <form action="{{ route('admin.services.update', $services->id) }}" method="POST" class="form-example">
                    ...
                    <div class="data-info-pane">
                        <div class="information name">
                            ...
                            <input type="text" id="name" name="name" class="content" value="{{ $services->name }}"/>
                        </div>

                        <div class="information">
                            <label class="type" for="description">DESCRIPTION</label>
                            <textarea id="description" name="description" class="content" rows="4" style="width: 100%; padding: 10px;">{{$services['description']}}</textarea>
                        </div>
